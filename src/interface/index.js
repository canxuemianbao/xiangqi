...
const { search } = require('../core/ai2/main')
...
function display() {
  ...
  pos.board.forEach((chessNum, coordinatePos) => {
    coordinates[coordinatePos].setChess(chesses[chessNum])
  })
...
function unSelectFrom() {
  ...
  coordinates[pos].classList.remove('selected')
}
